...
function preload() {
  ...
  images[0] =
    // loadImage("././././practice/final/media/birb.jpg");
  // "Le Penseur", Auguste Rodin, 1880
  thinkingman =loadImage('/p5/addons/asciiart/examples/example_image_Thinking-Man.jpg');
  // p5\addons\asciiart\examples\example_image_Thinking-Man.jpg
  // "American Gothic", Grant DeVolson Wood, 1930
  images[2] = loadImage('/p5/addons/asciiart/examples/example_image_young_man_reading.jpg');
  // "La Liseuse", Jean-Honoré Fragonard, 1770
  images[3] = loadImage('/p5/addons/asciiart/examples/example_image_young_girl_reading.jpg');
}
...
function mouseClicked(){
  ...
  */
  gfx.image(thinkingman, 0, 0, gfx.width, gfx.height);
  /*
